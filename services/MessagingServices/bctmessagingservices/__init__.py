...
class EntryPoint(object):
    ...
    def start(self):
        messaging_builder = self.env.get_component_factory('bctks.messaging', 'BackcountryTracks_Messaging', 'MessagingBuilder')
        messaging_builder(self.on_recv_channel_opened)
